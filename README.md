...
- 88% of nations (159 countries) showing upward growth in 2023
- Asia leads global growth at 4.5% (weighted), driven by China (5.25%) and India (8.15%)
- US + China = 43.9% of world economy
- 147% gap between average ($17,711) and median ($7,180) GDP per capita

## Dashboard Pages
1. Overview - The big picture
2. Regional Analysis - Growth by continent
3. Income Analysis - Mega vs Micro economies
4. Data Story - Full narrative + strategic insights

## Live Demo
Coming soon - DM me on LinkedIn for early access

## Download the PBIX File
[Download Global-GDP-Dashboard-2023.pbix](https://github.com/Dannywhilz001/global-gdp-powerbi-dashboard/blob/main/Global%20GDP%20Analysis%20Dashboard%202023.pbix)
